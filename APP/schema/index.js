...
// Using db._collection allows us to use the
...
const episodes = db._collection('episodes');
const characters = db._collection('characters');
const friends = db._collection('friends');
const appearsIn = db._collection('appearsIn');
