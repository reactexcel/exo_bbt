...
// const getTransferAvailabilityXML = require('../utils/tpXMLScripts').getTransferAvailabilityXML;
...
// function addPromotions(tpDoc, valueAdds, resultTransfer) {
...
// 		resultTransfer.promotions = promotions;
// 	}
...
// 	}
// 	resultTransfer.hasPromotions = promotions.length > 0;
// }
...
// function getTransferAvailability(requestXML, tourplanServerUrl, countryCode, useEscap) {
// 	let result = [];
...
// 	let option = json.Reply.OptionInfoReply.Option;

// 	if (option) {
// 		// Array
// 		if (option.length) {
// 			result = option.map(o => transformAvailableResult(o, countryCode));
// 		}
// 		// Single object
// 		else {
// 			result = [transformAvailableResult(option, countryCode)];
// 		}
// 	}
...
/** Retrieves a transfer availability from OptionNumber.
 *
 * Retrieves a transfer availability from OptionNumber.
...
// 	const productIds = req.body.productIds.map(p => removeCountryCode(p));
...
// 	const requestAvailableXML = getTransferAvailabilityXML({
// 		agentid: agentid,
// 		password: password,
...
// 	const serverUrl = servers[country.toLowerCase() + '_test_server']; // Currently transfers only work on Thailand TestServer2 // TODO: User real servers when they up and running

// 	let result = getTransferAvailability(requestAvailableXML, serverUrl, countryCode[country.toLowerCase()], false);

// 	for (var i = 0; i < result.length; i++) {
// 		var r = result[i];
// 		ServiceBookings.updateServiceBooking(serviceBookingKeys[i], {price: {currency: r.currency}})
// 	}

// 	res.json(result);
// })
// 	.body(require('../models/TransferAvailability'), 'The product you want to check');
...
<OptionNumber>52388</OptionNumber>
<Info>S</Info>
